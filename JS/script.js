...
const contact_new = document.getElementById('contact_new');
const registerBtn = document.getElementById('register');
const loginBtn = document.getElementById('login');

registerBtn.addEventListener('click', () => {
  contact_new.classList.add("active");
});

loginBtn.addEventListener('click', () => {
  contact_new.classList.remove("active");
});
...
buttons[0].addEventListener("click", () => {
  ...
  song.src = "./assets/Songs/chaleya.mp3";
  songName.innerText = "Chaleya";
  songBy.innerText = "Kasyap";
  title.innerText = "Chaleya";
...
buttons[1].addEventListener("click", () => {
  ...
  song.src = "./assets/Songs/O Mahi O Mahi.mp3";
  songName.innerText = "I Like Me Better";
  songBy.innerText = "Lauv";
  title.innerText = " I Like Me Better";
  download.href = "E:\DD MUSIC\assets\Songs\O Mahi O Mahi.mp3";
